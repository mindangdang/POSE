...
function MainApp() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      ...
      <nav className="fixed bottom-5 left-1/2 z-50 flex -translate-x-1/2 items-center gap-1 rounded-full border border-black/10 bg-white/90 p-2 shadow-[0_18px_60px_rgba(0,0,0,0.18)] backdrop-blur-md">
        {[
          ...
          <button
            ...
            className={`flex min-w-[74px] flex-col items-center rounded-full px-3 py-2 text-[10px] font-bold uppercase tracking-wider transition-all ${currentTab === id ? 'bg-black text-white' : 'text-black/55 hover:bg-black/5 hover:text-black'}`}
          >
