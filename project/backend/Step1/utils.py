...
async def fetch_from_single_site(client: httpx.AsyncClient, base_query: str, translated_query: str, domain: str, site_name: str, current_page: int, serp_api_key: str) -> list[dict]:
